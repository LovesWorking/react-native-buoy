/**
 * @react-buoy/highlight-updates/benchmarking
 *
 ...
 *
 * This module is designed to be self-contained for easy extraction
 * to a separate package later.
 *
 * @example
 * ```typescript
 * import {
 ...
 * } from '@react-buoy/highlight-updates/benchmarking';
 *
 * // Start recording
